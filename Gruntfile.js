...
module.exports = function(grunt) {
  ...
  var config = {
    ...
    purifycss: {
      target: {
        ...
        css: ['build/styles/final.css'],
        dest: 'build/styles/final-pure.css'
      }
    },
  ...
  // Register tasks
  grunt.registerTask('build', ['googlefonts', 'exec:build', 'purifycss', 'critical', 'replace']);
