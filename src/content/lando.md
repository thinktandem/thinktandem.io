...
It is a free and open-source local development environment built on Docker container technology. Lando runs on Mac, Windows, and Linux, providing an easy way for users to specify simple or complex development requirements for projects using many popular languages, frameworks, and services.
